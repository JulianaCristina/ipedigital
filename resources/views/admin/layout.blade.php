...
<head>
  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
      ...
      @elseif(Auth::user()->idTipoUsuario == 1)
      ...
      <ul class="nav navbar-nav ml-auto">          
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <a class="dropdown-item" href="/home"><i class="fa fa-user"></i>{{ Auth::user()->name }}</a>
              ...
              <li class="nav-item nav-dropdown">
                ...
                <div class="app-body">
                  <div class="sidebar">
                    <nav class="sidebar-nav">
                      <ul class="nav">
                        ...
                        <li class="nav-item nav-dropdown">
                          ...
                          <li class="nav-item nav-dropdown">
                            <a class="nav-link nav-dropdown-toggle" href="#">
                              <i class="nav-icon icon-star"></i> Vendas
                            </a>
                            <ul class="nav-dropdown-items">
                              <li class="nav-item">
                                <a class="nav-link" href="/venda/listaVenda" target="_top">
                                  <i class="nav-icon icon-star"></i> Listar Vendas
                                </a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="register.html" target="_top">
                                  <i class="nav-icon icon-star"></i> Nova Venda
                                </a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="404.html" target="_top">
                    ...
                    @elseif(Auth::user()->idTipoUsuario == null)
                    return redirect('/naoTemAcesso');
                    @endguest
                    <main class="main">
                      <!-- Breadcrumb-->
